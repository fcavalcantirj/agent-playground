  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-primary/15 data-[state=active]:text-primary data-[state=active]:border-primary/30 data-[state=active]:shadow-[0_0_12px_rgba(249,115,22,0.15)]",
