...
import { Terminal, Github, Mail, Lock, User, ArrowRight, Eye, EyeOff, Check } from "lucide-react"
...
export default function SignupPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-background p-4 py-12">
      <ParticleBackground />
              ...
              <div className="mt-2 space-y-1">
                {passwordChecks.map((check, i) => (
                  <div key={i} className="flex items-center gap-2 text-xs">
                    <div className={`flex h-4 w-4 items-center justify-center rounded-full ${check.valid ? "bg-green-500/20 text-green-500" : "bg-muted text-muted-foreground"}`}>
