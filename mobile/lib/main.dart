...
//    first frame.
//
// Phase 31 H6 (D-11) — entire body wrapped inside initSentry(runner: …)
// so SentryFlutter.init owns the zone for zone-bound error capture.
// No-op when SENTRY_DSN_MOBILE dart-define is empty (D-14).
