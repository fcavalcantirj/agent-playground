...
**Plans:** 5 plans
Plans:
- [ ] 10-01-PLAN.md — Loosen schema: add category/detail as OPTIONAL + 11-value enum + build.timeout_s/clone_timeout_s [Wave 1]
- [ ] 10-02-PLAN.md — Migrate 5 committed recipes (ruamel round-trip) adding category+detail per D-04 [Wave 2]
- [ ] 10-03-PLAN.md — Tighten schema: category/detail REQUIRED on verified_cells + known_incompatible_cells [Wave 3]
- [ ] 10-04-PLAN.md — Runner: Category enum + Verdict dataclass + preflight_docker + cidfile timeout + main() refactor [Wave 3]
